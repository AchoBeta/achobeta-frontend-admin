<template>
    ...
    <div class="login-box  w-3/5 h-full flex  justify-center items-center" s>
        <form class="form">
            <div class="check-box">
                <button class="btn btn-primary btn-sm w-20 rounded rounded-r-none rounded-l-lg">登录</button>
                <button class="btn  btn-sm w-20 rounded rounded-l-none rounded-r-lg">注册</button>
            ...
            <div class="inputForm">
                ...
                <svg t="1715312405389" class="icon" viewBox="0 0 1024 1024" version="1.1"
            ...
            <button class="btn btn-primary text-white  w-full">Sign In</button>
