      ...
      <a-spin :spinning="loading">
        ...
        >
          <a-descriptions-item
            ...
            :span="2"
          >
            {{ resumeData.stuSimpleResumeVO.name
            }}
          </a-descriptions-item>
          ...
          <a-descriptions-item
            ...
            :span="1"
          >
            {{ resumeData.stuSimpleResumeVO.grade
            }}
          </a-descriptions-item>

          <a-descriptions-item label="学号">
            {{ resumeData.stuSimpleResumeVO.studentId }}
          </a-descriptions-item>

          <a-descriptions-item label="性别">
            {{ resumeData.stuSimpleResumeVO.gender === 0 ? '男' : '女'
            }}
          </a-descriptions-item>

          <a-descriptions-item label="专业">
            {{ resumeData.stuSimpleResumeVO.major }}
          </a-descriptions-item>
          <a-descriptions-item
            label="班级"
            :span="2"
          >
            {{ resumeData.stuSimpleResumeVO.className
            }}
          </a-descriptions-item>
          ...
          <a-descriptions-item
            ...
            :span="2"
          >
            {{ resumeData.stuSimpleResumeVO.email
            }}
          </a-descriptions-item>
          <a-descriptions-item label="电话号码">
            {{ resumeData.stuSimpleResumeVO.phoneNumber
            }}
          </a-descriptions-item>
          <a-descriptions-item
            label="加入理由"
            :span="3"
          >
            {{ resumeData.stuSimpleResumeVO.reason
            }}
          </a-descriptions-item>
          <a-descriptions-item
            label="简介"
            :span="3"
          >
            {{ resumeData.stuSimpleResumeVO.introduce
            }}
          </a-descriptions-item>
          <a-descriptions-item
            label="经历"
            :span="3"
          >
            {{ resumeData.stuSimpleResumeVO.experience
            }}
          </a-descriptions-item>
          ...
          <a-descriptions-item
            ...
            :span="3"
          >
            {{ resumeData.stuSimpleResumeVO.awards
            }}
          </a-descriptions-item>
          <a-descriptions-item
            label="备注"
            :span="3"
          >
            {{ resumeData.stuSimpleResumeVO.remark
            }}
          </a-descriptions-item>
          <a-descriptions-item
            label="附件"
          ...
          >
            <div class="w-full flex flex-col items-start">
              <template
                v-for="item in resumeData.stuAttachmentVOList"
                :key="item.id"
              >
                <a-button
                  type="link"
        ...
        <resume-status
          :resume-id="resumeId"
          :get-resume-detail="getResumeDetail"
        />
      </a-spin>
    </a-modal>
  </div>
