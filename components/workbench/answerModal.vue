...
<template>
  <div>
    <a-modal class="custom-modal-width" :width="modalWidth()" :footer="null" v-model:open="open" @ok="handleOk">
      <template #title>
        <span class="mr-4">问卷填写情况</span><a-tag color="green">{{ userName }}</a-tag>
      </template>
      <a-spin :spinning="loading">
        <div class="flex flex-col">
          <div class="w-full mb-2" v-for="(item, index) in answerList" :key="index">
