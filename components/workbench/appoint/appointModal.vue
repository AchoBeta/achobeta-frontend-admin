  ...
  <a-modal :width="820" :open="modalVisible" :footer="null" title="预约管理" @cancel="closeModal" @ok="confirmAppointment">
    <a-spin :spinning="loading">
      <div class="flex flex-col w-full mt-4">
        <div class="flex">
          <div class="min-w-[100px]">参考时间段：</div>
          <a-row v-if="timePeriodVOS?.length > 0" :gutter="12" class="w-full">
            <a-col class="mb-4" :span="12" v-for="(item, index) in timePeriodVOS" :key="index">
              <div class="flex">
