    ...
    >
      ...
      >
        ...
        <a-select
          ...
          mode="tags"
          placeholder="请填写面试地点"
          :options="[{ label: '线上面试', value: '线上面试' }, { label: '网安楼9A206', value: '网安楼9A206' }]"
        />
      </a-form-item>
      ...
      <a-form-item
        label="描述"
        name="description"
        :rules="[{ required: true, message: '请填写面试描述' }]"
      >
        <a-textarea
      ...
      <a-form-item label="会议号">
        <a-input
          v-model:value="meetingState.meetingId"
      ...
      <a-form-item
        label="URL"
        help="请自行保存，会议链接有效期至面试预约结束日期"
      >
        <a-input
          v-model:value="meetingState.url"
          :disabled="!formState.title"
          placeholder="请填写跳转地址"
        />
      </a-form-item>
      ...
      <a-form-item label="APP链接">
        <a-input
          v-model:value="meetingState.appUrl"
          :disabled="!formState.title"
          placeholder="请填写跳转地址"
        />
      </a-form-item>
