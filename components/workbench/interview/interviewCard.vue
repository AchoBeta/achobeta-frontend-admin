...
<template>
  <header class="flex mt-4 mx-4">
    <div class="flex min-w-[380px]">
      ...
      <a-space>
        <a-checkable-tag
          v-for="(item, index) in interviewOptions"
          :key="item.id"
          ...
          >
            <template #title>
              <div class="flex justify-between">
                ...
                >
                  {{
                    INTERVIEW_STATUS[item?.status as keyof typeof INTERVIEW_STATUS].name }}
                </a-tag>
              </div>
            </template>
            ...
            <div class="flex justify-between w-full">
              <a-typography-paragraph
                style="min-height: 40.5px;margin-bottom: 10px"
            ...
            <div class="flex mb-2">
              <div class="mr-2 min-w-[32px]">
                地址:
              </div>
              <div>
                <a-typography-paragraph
                  style="min-height: 44px; margin-bottom: 0px"
                  :ellipsis="{ rows: 2, tooltip: item?.description }"
            ...
            <div>
              <div class="mb-1">
                开始时间: {{ dayjs(item?.scheduleVO.startTime).format('YYYY-MM-DD HH:mm:ss') }}
              </div>
