  ...
  <a-spin :spinning="loading">
    ...
    >
      <a-descriptions-item
        ...
        :span="2"
      >
        {{ resumeDetail.stuSimpleResumeVO.name
        }}
      </a-descriptions-item>
      ...
      <a-descriptions-item
        ...
        :span="1"
      >
        {{ resumeDetail.stuSimpleResumeVO.grade
        }}
      </a-descriptions-item>

      <a-descriptions-item label="学号">
        {{ resumeDetail.stuSimpleResumeVO.studentId }}
      </a-descriptions-item>

      <a-descriptions-item label="性别">
        {{ resumeDetail.stuSimpleResumeVO.gender === 0 ? '男' : '女'
        }}
      </a-descriptions-item>

      <a-descriptions-item label="专业">
        {{ resumeDetail.stuSimpleResumeVO.major }}
      </a-descriptions-item>
      <a-descriptions-item
        label="班级"
        :span="2"
      >
        {{ resumeDetail.stuSimpleResumeVO.className
        }}
      </a-descriptions-item>
      ...
      <a-descriptions-item
        ...
        :span="2"
      >
        {{ resumeDetail.stuSimpleResumeVO.email
        }}
      </a-descriptions-item>
      <a-descriptions-item label="电话号码">
        {{ resumeDetail.stuSimpleResumeVO.phoneNumber
        }}
      </a-descriptions-item>
      <a-descriptions-item
        label="加入理由"
        :span="3"
      >
        {{ resumeDetail.stuSimpleResumeVO.reason
        }}
      </a-descriptions-item>
      <a-descriptions-item
        label="简介"
        :span="3"
      >
        {{ resumeDetail.stuSimpleResumeVO.introduce
        }}
      </a-descriptions-item>
      <a-descriptions-item
        label="经历"
        :span="3"
      >
        {{ resumeDetail.stuSimpleResumeVO.experience
        }}
      </a-descriptions-item>
      ...
      <a-descriptions-item
        ...
        :span="3"
      >
        {{ resumeDetail.stuSimpleResumeVO.awards
        }}
      </a-descriptions-item>
      <a-descriptions-item
        label="备注"
        :span="3"
      >
        {{ resumeDetail.stuSimpleResumeVO.remark
        }}
      </a-descriptions-item>
