...
import { getInterviewSummaryApi, summarizeInterviewApi } from '~/api/interviewEvaluation'
...
<template>
  ...
  >
    ...
    >
      <a-input
        v-model:value="formState.playback"
        placeholder="请填写面试回放链接"
      />
    </a-form-item>
    ...
    >
      <a-textarea
        v-model:value="formState.suggest"
        placeholder="请填写给面试者的建议"
        :rows="3"
      />
    </a-form-item>
    ...
    >
      <a-textarea
        v-model:value="formState.evaluate"
        placeholder="请填写面试总评"
        :rows="3"
      />
    </a-form-item>
